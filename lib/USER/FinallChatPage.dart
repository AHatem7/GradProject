...
class ChatPageFinal extends StatefulWidget {
  ...
  ChatPageFinal({required this.selectedUser});

  @override
  _ChatPageFinalState createState() => _ChatPageFinalState();
}
    ...
    return Stack(
      children: [
        ...
        Scaffold(
          ...
          appBar: AppBar(
            backgroundColor: Colors.transparent,
            title: Text(widget.selectedUser['firstname'] + ' ' + widget.selectedUser['lastname']),
          ),
          body: Column(
            children: [
              Expanded(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        bool isSentByCurrentUser = document['sender'] == widget.selectedUser['firstname'] + ' ' + widget.selectedUser['lastname'];
                        return Align(
                          ...
                          child: Padding(
                            ...
                            child: Material(
                              ...
                              elevation: 4,
                              color:  isSentByCurrentUser ? Colors.blueGrey : Colors.grey[300],
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        ...
                        if (text.isNotEmpty) {
                          ...
                          'text': text,
                          'sender': widget.selectedUser['firstname'] + ' ' + widget.selectedUser['lastname'],
