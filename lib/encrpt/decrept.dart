...
//                       final decryptedFile = File(fileResult!.files.single.path!);
//                       final decryptedFilePath =
//                       decryptedFile.path.substring(0, decryptedFile.path.lastIndexOf('.'));
//                       final decryptedFileName = decryptedFile.path.split('/').last;
//                       final newFilePath = '$decryptedFilePath.decrypted.$decryptedFileName';
//                       final crypt = AesCrypt();
//                       crypt.setPassword(_passwordController.text);
//                       crypt.aesSetMode(AesMode.cbc);
//                       crypt.setOverwriteMode(AesCryptOwMode.warn);
//                       try {
//                         _decryptedFilePath = crypt.decryptFileSync(_fileName!, newFilePath);
...
//                     child: Text('Decrypt'),
//                   ),
//                   if (_decryptedFilePath != null) Image.file(File(_decryptedFilePath!)),
//                 ],
//               ),
//             ],
//           ),
